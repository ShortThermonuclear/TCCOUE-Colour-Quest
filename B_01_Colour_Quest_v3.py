...
def get_colours():
    ...
    :return: list of colours which where each list has the
    colour name, associate score and foreground colour for the text
    """
...
def get_round_colours():
    """
    Choose four colours from large list ensuring that the scores are all different
    ...
    while len(round_colours) < 4:
        ...
        # Get the core and check it's not a duplicate
...
class StartGame:
    ...
    def __init__(self):
        ...
        # List of labels to nade ( text| font| fg )
        start_labels_list = [
            ["Colour Quest", ("Arial", "16", "bold"), None],
            [intro_string, ("Arial", "16"), None],
        ...
        for count, item in enumerate(start_labels_list):
            make_label = Label(self.start_frame, text=item[0], font=item[1],
                               fg=item[2],
                               wraplength=350, justify="left", pady=10, padx=10)
        ...
        self.num_rounds_entry = Entry(self.entry_area_frame, font = ["Arial", "20", "bold"],
                                      width=10)
        self.num_rounds_entry.grid(row=0, column = 0, pady=10, padx=10)
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        # If user press the 'x' on the game window end the entire game!
        ...
        play_labels_list = [
            ...
            ["Choose a colour below. Good luck. 🍀", body_font, "#D5E6D4", 2],
        ...
        # Disable stats button as there is no information at the start.
    ...
    def round_results(self, user_choice):
        ...
        """
        # enables stats button after at least one round has been played.
    ...
    def to_hints(self):
        ...
        # check we have played at least one rounds so
        # that stats button is not enables in error.
        rounds_played = self.rounds_played.get()
...
class DisplayHints:
    ...
    def __init__(self, partner, rounds_played):
        ...
        self.hint_box.protocol('WM_DELETE_WINDOW', partial(self.close_help, partner))

        self.hints_frame = Frame(self.hint_box, width=300,
        ...
        hints_text = ("The score for each colour relates to it's hexadecimal code. \n\n"
                      ...
                      "possible score. \n\n"
                      "The hex code for black is #000000 which ic the worst possible score.\n\n"
...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        for count, item in enumerate(all_stats_strings):
            ...
            stats_labels_ref_list.append(self.stats_label)

        # Configure comment label background (for all won / all lost)
        stats_comment_label = stats_labels_ref_list[4]
        ...
        # close stats dialogue (used by button and x at the top of dialogue)
